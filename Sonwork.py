...
def admin_win():
    ...
    admin.eval('tk::PlaceWindow . center') #THAY ĐỔI CODE 
...
def display_book_win():
    ...
    Button(display_book, text="Add to cart",command = my_cart_win,height=3, width= 13).place(x=600, y=130)
    tk.Label(display_book, text="Type ID book to buy").place(x=10, y=70)
    customer_buy = Entry(display_book)
    customer_buy.place(x=200, y=70)
